...
public enum BiomeGroup {
    ...
    TAIGA(Biome.TAIGA, Biome.OLD_GROWTH_PINE_TAIGA, Biome.OLD_GROWTH_SPRUCE_TAIGA, Biome.SNOWY_TAIGA,
            Biome.WINDSWEPT_HILLS, Biome.WINDSWEPT_GRAVELLY_HILLS, Biome.WINDSWEPT_FOREST, Biome.GROVE),
    FOREST(Biome.FOREST),
    ...
    DAPPLED_FOREST(Biome.DAPPLED_FOREST);
