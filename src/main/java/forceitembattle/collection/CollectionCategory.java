...
public enum CollectionCategory {
    ...
    MUSIC_DISCS("Music Discs", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvODNlYjVkMjJhZWM5NjI5ODQ1Njg1YWY3MTJjYmRmYjg2Zjc1NjVkYjQ3NDk5MzViNTc3ZjliZWIwOTI4MDBhMCJ9fX0=", name -> name.startsWith("MUSIC_DISC")),
    POTTERY_SHERDS("Pottery Sherds", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNGNlNDFjZWY1ZGViYjIyY2M0NWQ4N2Y0MDg1NWQ4OWM0NDJjZWJiYjk4MjBjNDdjZDRkMWYzODlmZGUzNmNmOSJ9fX0=", name -> name.endsWith("_POTTERY_SHERD")),
    TEMPLATES("Templates & Patterns", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzc3ZTQwYmIwYjM3MWIzNzQ1ZGZlNWVkNTIwMzNmZmNmYzhjODJmZWVmYzI1YjM0YmFjN2FlZDFmZjljZTU4ZiJ9fX0=", name ->
            name.endsWith("_SMITHING_TEMPLATE") || name.endsWith("_BANNER_PATTERN")),
    MAPS("Maps", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOWNlZjEzNzZhMGU1ZGNhN2NiODIxZDViYTZmYzQ2MTFmYTJmNWVhNmQ4M2M2NzU5NzNhMDhiZmZjMDI5YmEzOCJ9fX0=", CollectionCategory::isMap),
    ...
    COPPER("Copper", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmQ1NzI0YTc5ZjkwZmQxZTU0NzY1ZDc1OTY5MjgxNDZkY2I5ZTUwZmRiODg1OTYyMDFjNGEyMzVjNGE2ZjRlZSJ9fX0=", name ->
            name.contains("COPPER") || name.contains("LIGHTNING_ROD")),
    ...
    CORALS("Corals", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOWZlOGRlZDNjNzRlYWNkNzg0MTJhOTAzYjkwNGY1NTc3ODUwZDFlMjBkMzQ4NzhmZDc3NTk3YWQxNjMzYmY3NCJ9fX0=", name -> name.contains("CORAL")),
    DYES("Dyes", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNDdjOTAzY2ZjM2NlOGJkYTU5YzgzZTViYjc4NTU1MjJkYzE3ZmViMmI4MTI4ZDA3NDc4NmYyMDBkNzMwYzdiNCJ9fX0=", name -> name.endsWith("_DYE")),
    ...
    CollectionCategory(String displayName, String headTexture, Predicate<String> matcher) {
    ...
    public static CollectionCategory categoryOf(Material material) {
        return categoryOf(material.name());
    }

    /** Every predicate here reads only the material name, so this is the whole of the logic. */
    public static CollectionCategory categoryOf(String materialName) {
        ...
        if (CustomMaterials.byMaterialName(materialName) != null) {
            return CUSTOM_ITEMS;
        }
        for (CollectionCategory category : values()) {
            if (category.matcher.test(materialName)) {
                return category;
            }
        }
        return OTHER;
    ...
    private static boolean isToolItem(String name) {
        return MaterialCategory.isTool(name) || name.endsWith("_SPEAR");
    }

    private static boolean isArmorItem(String name) {
        // The suffix covers wolf/horse/nautilus armour, which MaterialCategory.isArmor does not.
        return MaterialCategory.isArmor(name) || name.endsWith("_ARMOR");
    }
    ...
    private static boolean isFoodItem(String name) {
        return switch (name) {
            ...
            default -> MaterialCategory.isFood(name);
        };
    }

    // Every structure map is its own material; the blank MAP and FILLED_MAP join them here.
    private static boolean isMap(String name) {
        return name.equals("MAP") || name.equals("FILLED_MAP") || name.endsWith("_MAP");
    }

    private static boolean isGlass(String name) {
        return !name.equals("SPYGLASS") && name.contains("GLASS");
    }

    private static boolean isWoodItem(String name) {
        ...
        return MaterialCategory.isWoodType(name) || name.equals("STICK") || name.endsWith("BAMBOO_BLOCK");
    }

    private static boolean isStoneItem(String name) {
    ...
    private static boolean isNetherBlock(String name) {
    ...
    private static boolean isFlowerOrPlant(String name) {
        ...
        return switch (name) {
            case "DANDELION", "GOLDEN_DANDELION", "POPPY", "BLUE_ORCHID", "ALLIUM", "AZURE_BLUET",
                 ...
                 "SHORT_GRASS", "TALL_GRASS", "BUSH", "DEAD_BUSH", "FIREFLY_BUSH", "RED_SHRUB",
                 "SEAGRASS", "KELP",
    ...
    private static boolean isWoolOrFabric(String name) {
        // contains, not endsWith: WOOL_SLAB and WOOL_STAIRS carry the colour prefix and a _WOOL infix.
        return name.equals("WOOL") || name.contains("_WOOL")
    ...
    private static boolean isConcreteOrTerracotta(String name) {
    ...
    private static boolean isDirtOrSoil(String name) {
    ...
    private static boolean isMobDrop(String name) {
    ...
    private static boolean isUtility(String name) {
        ...
        return switch (name) {
            case "TORCH", "LANTERN", "CAMPFIRE", "BUCKET", "BUNDLE", "BOWL", "JUKEBOX",
                 ...
                 "SPYGLASS", "NAME_TAG", "LEAD", "SHIELD", "ELYTRA", "TOTEM_OF_UNDYING",
